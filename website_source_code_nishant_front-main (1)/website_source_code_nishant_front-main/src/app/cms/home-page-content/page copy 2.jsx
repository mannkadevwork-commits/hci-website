...
const CmsHowItsWorks = () => {
    ...
    {pagesList_what_we_are.map((item, index) => (
        <tr key={index}>
                    ...
                    <>
                        <form onSubmit={handleSubmit}>
                            <div className="modal-body row">
                                ...
                                <div className="mb-3 col-md-12">
                                    <label htmlFor="top_description" className="form-label">Content</label>
                                    <textarea
                                        className="form-control"
                                ...
                                <div className="mb-3 col-md-12">
                                    <label htmlFor="mid_sub_title" className="form-label">Youtube Link</label>
                                    <input
                                        type="text"
                                        className="form-control"
                                        name="mid_sub_title"
            ...
            <div className="container my-5">
                <h1 className="mb-4 text-center">CMS - Every Space</h1>
                {loading ? (
                    <div className="text-center">Loading...</div>
                ) : (
                    <>
                        <form onSubmit={handleSubmit_every_space}>
                            <div className="modal-body row">

                                <div className="mb-3 col-md-12">
                                    <label htmlFor="top_title" className="form-label">Heading 1</label>
                                    <input
                                        type="text"
                                        className="form-control"
                                        name="top_title"
                                        placeholder="Top Title"
                                        value={formData2.top_title}
                                        onChange={handleInputChange_every_space}
                                        required
                                    />
                                </div>
                                <div className="mb-3 col-md-12">
                                    <label htmlFor="top_description" className="form-label">Heading 2</label>
...
<input
                                        ...
                                        className="form-control"
                                        name="top_description"
                                        placeholder="top_description"
                                        value={formData2.top_description}
                                        onChange={handleInputChange_every_space}
                                        required
                                    />
                                </div>
